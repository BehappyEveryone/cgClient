            ...
            if (!MF_title.text.isEmpty() && !MF_content.text.isEmpty()) {
                ...
                when (ImageNum) {
                    ...
                    1 -> {
                        ...
                        part1 = if(imagepathArrayList[0].subSequence(0,6) == "forums") {
                    ...
                    2 -> {
                        ...
                        part2 = if(imagepathArrayList[1].subSequence(0,6) == "forums") {
                    ...
                    3 -> {
                        ...
                        part3 = if(imagepathArrayList[2].subSequence(0,6) == "forums") {
                    ...
                    4 -> {
                        ...
                        part4 = if(imagepathArrayList[3].subSequence(0,6) == "forums") {
                    ...
                    5 -> {
                        ...
                        part5 = if(imagepathArrayList[4].subSequence(0,6) == "forums") {

...
import com.example.chatground2.api.Api
...
class forums : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        searcharraAdapter =
            ArrayAdapter.createFromResource(context, R.array.data_search, android.R.layout.simple_spinner_item)
        ...
        view.F_bestforumsbutton.setOnClickListener {
            if (bestforum) {
                ...
                view.F_bestforumsbutton.background =
                    ContextCompat.getDrawable(this.context!!, R.drawable.forums_bestforums_icon)
                isLoading = false
                pageid = 1
                mAdapter.clear()
                ...
                bestforum = true
                view.F_bestforumsbutton.background =
                    ContextCompat.getDrawable(this.context!!, R.drawable.forumsitem_recommend)
                isLoading = false
                pageid = 1
                mAdapter.clear()
                GlobalScope.launch {
